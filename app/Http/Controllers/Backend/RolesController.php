...
class RolesController extends Controller
{
    ...
    public function create()
    {
        ...
        // $permissionCategory = PermissionCategory::get();
        // $permissions = [];
        // foreach($permissionCategory as $permissionCategories){
        //     $permissionCategories->sub = Permission::select('original_name', 'id')->where('permissions_category_id', $permissionCategories->id)->get();
    ...
    public function store(Request $request)
    {
        ...
        return redirect("backend/$module_name")->with('flash_success', "$module_name added!");
    }
    ...
    public function edit($id)
    {
        ...
        // $permissions = [];
        // foreach($permissionCategory as $permissionCategories){
        //     $permissionCategories->sub = Permission::where('permissions_category_id', $permissionCategories->id)->get();
        //     $permissions[]=  $permissionCategories;
        // }
