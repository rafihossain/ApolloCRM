...
<div class="card">
	<div class="card-body overflowhidden">
		...
		<ul class="nav nav-tabs nav-bordered border-0"> 
            <li class="nav-item">
                <a href="{{ route('backend.customfield-client') }}" class="nav-link active">
                    Client
                </a>
            </li> 
            <li class="nav-item">
