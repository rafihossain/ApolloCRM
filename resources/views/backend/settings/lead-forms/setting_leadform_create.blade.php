...
<form action="{{route('backend.setting-leadform-save')}}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="card">
    	<div class="card-body">
    		<h4>Add New Lead Form</h4>
                ...
                <div class="mb-2">
                    ...
                    <input type="text" class="form-control" name="save_form_as">
                    @error('save_form_as')
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <input type="file" class="dropify" name="header_image">
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <textarea class="form-control" placeholder="Header Text (e.g: Address / Contact Details)" name="header_text"></textarea>
                </div>
            </div>
                ...
                <div class="tab-pane show active" id="SystemFields">
                    ...
                    <div class="mb-2"> 
                        <h4 class="header-title mt-3 mb-3 clearfix">Team Members
                            <input type="checkbox" class="float-end" name="" id="team_member">
                        </h4>
                        <div class="row">
                            <div class="col-md-3 col-6 mb-2">
                                <div class="bg-light p-2"> 
                                    <input type="checkbox" class="float-end upload_profile_image" value="1" id="UploadProfileImage" name="upload_profile_image">
                            ...
                            <div class="col-md-3 col-6 mb-2">
                                <div class="bg-light p-2"> 
                                    <input type="checkbox" class="float-end date_of_birth" id="DateOfBirth" name="date_of_birth" value="1">
                                    <label class="form-check-label" for="DateOfBirth">Date Of Birth</label> 
                                </div>
                            </div>
                        </div>
                        <h4 class="header-title mt-3 mb-3 clearfix">Contact Details
                            <input type="checkbox" class="float-end contact_details" name="">
                        </h4>
                         
                        <div class="row">
                            <div class="col-md-3 col-6 mb-2">
                                <div class="bg-light p-2"> 
                                    <input type="checkbox" class="float-end contact_phone" id="uPhone" name="phone" value="1">
                            ...
                            <div class="col-md-3 col-6 mb-2">
                                <div class="bg-light p-2"> 
                                    <input type="checkbox" class="float-end secondary_email" id="SecondaryEmail" name="secondary_email" value="1">
                                    <label class="form-check-label" for="SecondaryEmail">Secondary Email</label> 
                                </div>
                            </div>
                            <div class="col-md-3 col-6 mb-2">
                                <div class="bg-light p-2"> 
                                    <input type="checkbox" class="float-end contact_preference" id="ContactPreference" name="contact_preference" value="1">
                       ...
                       <h4 class="header-title mt-3 mb-3 clearfix">Address Details
                            <input type="checkbox" class="float-end address_details" name="">
                        </h4> 
                        <div class="row">
                            <div class="col-md-3 col-6 mb-2">
                                <div class="bg-light p-2"> 
                                    <input type="checkbox" class="float-end address_street" id="uStreet" name="street" value="1">
                                    <label class="form-check-label" for="uStreet">Street</label> 
                                </div>
                            </div>
                            <div class="col-md-3 col-6 mb-2">
                                <div class="bg-light p-2"> 
                                    <input type="checkbox" class="float-end address_city" id="fCity" name="city" value="1">
                                    <label class="form-check-label" for="fCity">City</label> 
                                </div>
                            </div>
                            <div class="col-md-3 col-6 mb-2">
                                <div class="bg-light p-2"> 
                                    <input type="checkbox" class="float-end address_State" id="uState" name="state" value="1">
                                    <label class="form-check-label" for="uState">State</label> 
                                </div>
                            </div>
                            <div class="col-md-3 col-6 mb-2">
                                <div class="bg-light p-2"> 
                                    <input type="checkbox" class="float-end postal_code" id="uPostalCode" name="postal_code" value="1">
                                    <label class="form-check-label" for="uPostalCode">Postal Code</label> 
                                </div>
                            </div>
                            <div class="col-md-3 col-6 mb-2">
                                <div class="bg-light p-2"> 
                                    <input type="checkbox" class="float-end address_country" id="uCountry" name="country" value="1">
                                    <label class="form-check-label" for="uCountry">Country</label> 
                                </div>
                            </div>
                        </div>
                        <h4 class="header-title mt-3 mb-3 clearfix">Current Visa Information
                            <input type="checkbox" class="float-end current_visa_info" name="">
                        </h4>
                        
                        <div class="row">
                            <div class="col-md-3 col-6 mb-2">
                                <div class="bg-light p-2"> 
                                    <input type="checkbox" class="float-end visa_type" id="uVisaType" name="visa_type" value="1">
                                    <label class="form-check-label" for="uVisaType">Visa Type</label> 
                                </div>
                            </div>
                            <div class="col-md-3 col-6 mb-2">
                                <div class="bg-light p-2"> 
                                    <input type="checkbox" class="float-end visa_expiry_date" id="uVisaExpiryDate" name="visa_expiry_date" value="1">
                                    <label class="form-check-label" for="uVisaExpiryDate">Visa Expiry Date</label> 
                                </div>
                            </div>
                            <div class="col-md-3 col-6 mb-2">
                                <div class="bg-light p-2"> 
                                    <input type="checkbox" class="float-end country_of_passport" id="uCountryOfPassport" name="country_of_passport" value="1">
                        ...
                        <h4 class="header-title mt-3 mb-3 clearfix">Other Details
                            <input type="checkbox" class="float-end" name="">
                        </h4>
                       
                        <div class="row clearfix">
                            <div class="col-md-3 col-6 mb-2">
                                <div class="bg-light p-2"> 
                                    <input type="checkbox" class="float-end" id="uPreferredIntake" name="preferred_intake" value="1">
                        ...
                        <h4 class="header-title mt-3 mb-3 clearfix">Interested Services   
                            <input type="checkbox" id="usWorkflow" name="" checked="">
                            <label for="usWorkflow">Workflow</label>
                            <input type="checkbox" id="usPartner" name="workflow" value="1" checked="">
                            <label for="usPartner">Partner</label>
                            <input type="checkbox" id="usProduct" name="partner" value="1" checked="">
                            <label for="usProduct">Product</label>
                            <input type="checkbox" class="float-end interested_service" name="product" value="1">
                        </h4>
                       
                        <div class="row">
                            <div class="col-md-3 col-6 mb-2">
                                <div class="bg-light p-2"> 
                                    <input type="checkbox" class="float-end australian_education" id="uAustralianEducation" name="australian_education" value="1">
                                    <label class="form-check-label" for="uAustralianEducation">Australian Education</label> 
                                </div>
                            </div>
                            <div class="col-md-3 col-6 mb-2">
                                <div class="bg-light p-2"> 
                                    <input type="checkbox" class="float-end us_education" id="uUsEducationF1" name="us_education"  value="1">
                                    <label class="form-check-label" for="uUsEducationF1">Us Education F1</label> 
                                </div>
                            </div>
                            <div class="col-md-3 col-6 mb-2">
                                <div class="bg-light p-2"> 
                                    <input type="checkbox" class="float-end visa_service" id="uVISAService" name="visa_service" value="1">
                                    <label class="form-check-label" for="uVISAService">VISA Service</label> 
                                </div>
                            </div>
                            <div class="col-md-3 col-6 mb-2">
                                <div class="bg-light p-2"> 
                                    <input type="checkbox" class="float-end accomodation_service" id="uAccomodationService" name="accomodation_service" value="1">
                                    <label class="form-check-label" for="uAccomodationService">Accomodation Service</label> 
                                </div>
                            </div>
                            <div class="col-md-3 col-6 mb-2">
                                <div class="bg-light p-2"> 
                                    <input type="checkbox" class="float-end insurance_service" id="uInsuranceService" name="insurance_service" value="1">
                        ...
                        <h4 class="header-title mt-3 mb-3 clearfix">Education Background
                            <input type="checkbox" class="float-end education_background" name="">
                        </h4>
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-md-3 col-6 mb-2">
                                <div class="bg-light p-2"> 
                                    <input type="checkbox" class="float-end subject_area" id="uSubjectArea" name="subject_area" value="1">
                                    <label class="form-check-label" for="uSubjectArea">Subject Area</label> 
                                </div>
                            </div>
                            <div class="col-md-3 col-6 mb-2">
                                <div class="bg-light p-2"> 
                                    <input type="checkbox" class="float-end education_subject" id="uSubject" name="subject" value="1">
                                    <label class="form-check-label" for="uSubject">Subject</label> 
                                </div>
                            </div>
                            <div class="col-md-3 col-6 mb-2">
                                <div class="bg-light p-2"> 
                                    <input type="checkbox" class="float-end course_start" id="uCourseStart" name="course_start" value="1">
                                    <label class="form-check-label" for="uCourseStart">Course Start</label> 
                                </div>
                            </div>
                            <div class="col-md-3 col-6 mb-2">
                                <div class="bg-light p-2"> 
                                    <input type="checkbox" class="float-end course_end" id="uCourseEnd" name="course_end" value="1">
                                    <label class="form-check-label" for="uCourseEnd">Course End</label> 
                                </div>
                            </div>
                            <div class="col-md-3 col-6 mb-2">
                                <div class="bg-light p-2"> 
                                    <input type="checkbox" class="float-end academic_score" id="uAcademicScore" name="academic_score" value="1">
                        ...
                        <h4 class="header-title mt-3 mb-3 clearfix">English Test Scores
                            <input type="checkbox" class="float-end english_test_score" name="">
                        </h4>
                       
                        <div class="row clearfix">
                            <div class="col-md-3 col-6 mb-2">
                                <div class="bg-light p-2"> 
                                    <input type="checkbox" class="float-end english_tofel" id="uTOEFL" name="tofel" value="1">
                            ...
                            <div class="col-md-3 col-6 mb-2">
                                <div class="bg-light p-2"> 
                                    <input type="checkbox" class="float-end english_IELTS" id="uIELTS" name="IELTS" value="1">
                            ...
                            <div class="col-md-3 col-6 mb-2">
                                <div class="bg-light p-2"> 
                                    <input type="checkbox" class="float-end english_PTE" id="uPTE" value="1" name="PTE">
                        ...
                        <h4 class="header-title mt-3 mb-3 clearfix">Other Test Scores
                            <input type="checkbox" class="float-end other_test_score" name="">
                        </h4>
                       
                        <div class="row clearfix">
                            <div class="col-md-3 col-6 mb-2">
                                <div class="bg-light p-2"> 
                                    <input type="checkbox" class="float-end" id="uSATI" value="1" name="sat1">
                                    <label class="form-check-label" for="uSATI">SAT I</label> 
                                </div>
                            </div>
                            <div class="col-md-3 col-6 mb-2">
                                <div class="bg-light p-2"> 
                                    <input type="checkbox" class="float-end" id="uSATII" value="1" name="sat2">
                                    <label class="form-check-label" for="uSATII">SAT II</label> 
                                </div>
                            </div>
                            <div class="col-md-3 col-6 mb-2">
                                <div class="bg-light p-2"> 
                                    <input type="checkbox" class="float-end" id="uGRE" value="1" name="gre">
                                    <label class="form-check-label" for="uGRE">GRE</label> 
                                </div>
                            </div>
                            <div class="col-md-3 col-6 mb-2">
                                <div class="bg-light p-2"> 
                                    <input type="checkbox" class="float-end" id="uGMAT" value="1" name="gmat">
                        ...
                        <div class="row clearfix">
                            <div class="col-md-3 col-6 mb-2">
                                <div class="bg-light p-2"> 
                                    <input type="checkbox" class="float-end" id="uUploadDocuments" name="upload_document" value="1">
                        ...
                        <div class="row clearfix">
                            <div class="col-md-3 col-6 mb-2">
                                <div class="bg-light p-2"> 
                                    <input type="checkbox" class="float-end" id="uComments" value="1" name="comment">
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-control" name="related_office">
                        ...
                        @foreach($Office as $Offices)
                            <option value="{{$Offices->id}}">{{$Offices->office_name}}</option>
                        @endforeach    
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-control"  name="source">
                        ...
                        @foreach($SourceList as $SourceLists)
                            <option value="{{$SourceLists->id}}">{{$SourceLists->source_name}}</option>
                        @endforeach  
                    </select>
                </div>
                <div class="col-md-4">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <input type="checkbox" name="show_privacy_info" value="1"> <label>Show this information in lead form.</label>

            <div class="mb-2 mt-3">
                <label class="form-label">Privacy Information</label>
                <textarea class="summereditor" name="privacy_info"></textarea>
            </div>
            <div class="mb-4">
                ...
                <textarea class="summereditor" name="consent"></textarea>
            </div>
