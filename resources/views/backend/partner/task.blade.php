                ...
                <table id="datatable" class="table table-bordered dt-responsive table-responsive nowrap w-100">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript:void(0);" data-id="{{ $task->id }}" data-partner="{{ $task->partner_id }}" class="btn btn-sm btn-primary waves-effect waves-light editTaskModel"><i class="mdi mdi-square-edit-outline"></i></a>
                                <a href="{{ route('backend.deletepartner-task', ['id' => $task->id, 'partner_id'=> $task->partner_id ]) }}" id="delete" class="btn btn-danger btn-sm"><i class="mdi mdi-delete-outline"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#saveTask").click(function(e) {
            ...
            $.ajax({
                url: "{{ route('backend.addpartner-task') }}",
                type: "POST",
                data: fromData,
                cache:false,
                contentType: false,
        ...
        $('.editTaskModel').on("click", function() {
            ...
            $.ajax({
                url: "{{ route('backend.editpartner-task') }}",
                type: "POST",
                data: {
                    task_id: taskId,
        ...
        $(document).delegate('#update', 'click', function(e) {
            ...
            $.ajax({
                url: "{{ route('backend.updatepartner-task') }}",
                type: "POST",
                data: fromData,
                cache:false,
                contentType: false,
