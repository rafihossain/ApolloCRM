...
<div class="card">
    <div class="card-body"> 
        ...
        <h4 class="m-0 header-title text-end float-end">
            <a href="{{ route('backend.quotations-template-list') }}" class="btn btn-primary">Back to list</a>
        </h4>
    </div>
</div>
...
<div class="card">
    <div class="card-body">
        <form method="POST" action="{{ route('backend.quotations-template-update') }}">
            @csrf
                ...
                <div class="col-md-4 mb-2">
                    ...
                    <select class="form-control select11" name="office" data-width="100%">
                        ...
                        @foreach($offices as $office)
                            ...
                            {{ ($quotation->office == $office->id? 'selected':'') }}>{{ $office->office_name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-md-4 mb-2 parentselect2">
                    ...
                    <select class="form-control select12" name="quote_currency" data-width="100%">
                        ...
                        @foreach($currencies as $currency)
                            ...
                            {{ ($quotation->quote_currency == $currency->id? 'selected':'') }}>{{ $currency->currency_name.' [ '.$currency->currency_code.' ] ' }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
