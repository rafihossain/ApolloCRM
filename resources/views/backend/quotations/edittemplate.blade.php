...
<div class="card">
    <div class="card-body"> 
        <form method="POST" action="{{ route('backend.client-profile-quotations-updatesubmit', [$quotation->id]) }}">
            @csrf
        <div class="row mb-2">
            ...
            <div class="col-md-4 mb-2">
                ...
                <select class="form-control select11" name="office"  data-width="100%"> 
                    ...
                    <option value="1"  {{ ($quotation->office == 1? 'selected':'') }} > Head Office </option>
                </select>
            </div>
                ...
                <thead>
                 ...
                 <tbody id="add_product_info">
                    ...
                    <tr id="appendDiv{{ $product->id }}" class="appendDiv" attr="{{ $product->id }}">
                        ...
                        <td><div class="input-group mb-2"> <textarea class="form-control" name="description[]" rows="3">{{ $product->description }}</textarea></td>
                        <td><div class="input-group mb-2"><input type="text" class="form-control service_fee" name="service_fee[]" value="{{ $product->service_fee }}"></td>
                        <td><div class="input-group mb-2"><input type="text" class="form-control discount" name="discount[]" value="{{ $product->discount }}"></td>
                        <td><div class="input-group mb-2"><input type="text" class="form-control net_fee" name="net_fee[]" value="{{ $product->net_fee }}"></td>
                        <td><div class="input-group mb-2"><input type="text" class="form-control egx_rte" name="egx_rte[]" value="{{ $product->egx_rte }}"></td>
                        <td><div class="input-group mb-2"><input type="text" class="form-control total_ammount" name="total_ammount[]" value="{{ $product->total_ammount }}"></td>
                    <td><a attr="{{ $product->id }}" class="removeDiv" href="javascript:void(0)"><i class="mdi mdi-trash-can-outline"></i></a></td>
                    </tr>
                    @endforeach
