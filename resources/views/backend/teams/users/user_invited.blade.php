...
<div class="card">
            <div class="card-body"> 
                <h4 class="m-0 header-title text-end float-end"> 
                    <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#InviteUser" href="javascript:;" href="{{ route('backend.create-users') }}">+ Invite User</a>
                </h4>
                <ul class="nav nav-tabs nav-bordered border-0"> 
                    <li class="nav-item">
                        <a href="{{ route('backend.manage-users') }}" class="nav-link">
                            Active 
                        </a>
                    </li> 
                    <li class="nav-item">
                        <a href="{{route('backend.usersinactive')}}" class="nav-link">
                            Inactive
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{route('backend.usersinvited') }}" class="nav-link active">
                            Invited
                        </a>
                    </li> 
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                              ...
                              <a href="#" class="btn btn-info btn-sm"><i class="mdi mdi-email-outline"></i></a>
                             <a href="{{route('backend.cancel_invite',$user->id)}}" class="btn btn-danger btn-sm" id="cancel_invite"><i class="mdi mdi-account-cancel-outline"></i></a>
        ...
        <div class="modal-content">
            <form id="user_form_submit">
                <div class="modal-header">
                    <h4 class="modal-title" id="addcontact-modalLabel">Invite User</h4>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <input type="text" class="form-control @error('position_title') is-invalid @enderror" name="position_title" value="{{old('position_title')}}">
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <span class="text-danger" id="office"></span>
                        </div>
                        <div class="col-md-6 mb-2">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary user_submit">Invite  </button>
                </div>
            </form>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
...
<script>
    ...
    //user inactive-----------------
    $(document).on('click', '#cancel_invite', function(e) {
        e.preventDefault();
        var Id = $(this).attr('href');

        swal({
                title: "Are you sure?",
                text: "do you want to cancel invitation!",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            })
