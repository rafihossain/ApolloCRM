...
<div class="card">
            <div class="card-body"> 
                ...
                <ul class="nav nav-tabs nav-bordered border-0"> 
                    <li class="nav-item">
                        <a href="{{ route('backend.manage-users') }}" class="nav-link active">
                            Active 
                        </a>
                    </li> 
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="{{route('backend.usersinvited') }}" class="nav-link ">
                            Invited
                        </a>
                    </li> 
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('backend.user_inactive',$user->id)}}" class="btn btn-danger btn-sm" id="user_inactive"><i class="mdi mdi-account-cancel-outline"></i></a>
