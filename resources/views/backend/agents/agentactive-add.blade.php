...
<form method="POST" action="{{ route('backend.agent-save') }}" enctype="multipart/form-data" class="pb-4">
    @csrf
    <div class="card">
        <div class="card-body">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="mt-3 d-flex">
                <div class="form-check me-2">
                    <input type="radio" id="customRadio1" class="form-check-input individual" name="agent_structure" value="1" checked>
                    <label class="form-check-label" for="customRadio1">Individual</label>
                </div>
                <div class="form-check">
                    <input type="radio" id="customRadio2" class="form-check-input business" name="agent_structure" value="2">
    ...
    <div class="card">
        <div class="card-body">
            <div class="mb-2 show-personal">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <input type="file" class="dropify" name="personal_image" data-height="205" />
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
            ...
            <div class="mb-2 show-business d-none">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <input type="file" class="dropify" name="business_image" data-height="205" />
                    </div>
                    <div class="col-md-8">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="datetime-datepicker" name="expiry_date">
                            </div>
                        </div>
                    </div>
                </div>
